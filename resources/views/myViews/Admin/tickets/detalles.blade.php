                ...
                @method('PUT')
                  ...
                  <div class="row content-row" >
                    <div class="col-md-4 form-group btnAsistencia" >
                      <input type="submit" value="Dar asistencia" class="btnForm btn-primary ">
                    </div>
                    <div class="col-md-4 form-group btnAsistencia" >
                      <a href="/tecnicos/tickets/asignados/{{$ticket->id}}"  class="btn btn-info btn-asignarTec">ASIGNAR TÉCNICO</a>
                    </div>
                    <div class="col-md-4 form-group btnAsistencia">
                      <a href="/noasignados" class="btnForm btn-dark  btn_volver volver_detalles"> <i class="fa-solid fa-arrow-left fa-lg"></i> VOLVER </a>
                    </div>
                  </div>
